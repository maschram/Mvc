...
namespace Microsoft.AspNetCore.Mvc.RazorPages.Internal
{
    public class DefaultPageArgumentBinder : PageArgumentBinder
    {
        ...
        protected override async Task<ModelBindingResult> BindAsync(PageContext pageContext, object value, string name, Type type)
        {
            ...
            return await _parameterBinder.BindModelAsync(parameterDescriptor, pageContext, valueProvider, value);
        }

        public override async Task<ModelBindingResult> BindAsync(PageContext pageContext, ParameterDescriptor parameterDescriptor)
        {
            var valueProvider = await GetCompositeValueProvider(pageContext);
            return await _parameterBinder.BindModelAsync(parameterDescriptor, pageContext, valueProvider);
        }
